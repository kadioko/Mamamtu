...
**Document:** Free 3-Month Pilot Agreement — Terms & Conditions  
**Version:** 1.0  
**Effective Date:** June 2026  
**Parties:** Necuva Group Limited (operating as MamaMtu) and the Pilot Clinic (named in the signed agreement)

---

## 1. What Is Included in the Free Pilot
...
| Patient consent forms | 20 printed copies (English + Swahili bilingual) |
| Privacy notice poster | 1 laminated A4 poster for the clinic waiting area |
| Quick Start Guide | 3 laminated copies for clinical staff (step-by-step with screenshots) |
| Tablet support | Up to 2 tablets provided if the clinic has no suitable device (subject to availability) |
| Data export on exit | Full export of all entered data (Excel/PDF) at no cost if the clinic does not continue |
...
- Report any suspected security incident to MamaMtu within 24 hours
...
There is no automatic charge. The clinic must actively choose to continue on a paid plan.

---

## 4. Data Ownership and Privacy

- **Patient data belongs to the patient.** The clinic is the data controller. MamaMtu is the data processor.
...
MamaMtu is a record-keeping, workflow, and reporting tool. It is **not**:
...
All clinical decisions remain the responsibility of qualified healthcare professionals at the clinic. See the MamaMtu Clinical Safety Statement for full detail.
...
**Emergency (system down during patient care):** Call anytime

---

## 7. Termination

Either party may end the pilot at any time with 7 days' written notice (WhatsApp or email is sufficient).  
On termination, MamaMtu will provide a full data export within 5 business days.
